...
<?php 
 if($count==5)
 { ?>
  <div class="desktop-hide col-sm-12 col-sm-12-mod col-xs-12 col-md-4 col-lg-4 col-box wow fadeIn animation-off-mobilea" style="padding-left:15px; padding-right:15px; margin-bottom:0;">
