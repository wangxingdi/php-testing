...
<section class="col-md-10">
    ...
    <script>
        ...
        function countChar(val) {
            ...
            if (len >= 270) {
                val.value = val.value.substring(0, 270);
            } else {
                $('#charNum').text(270 - len);
            }
        };
    </script>
            ...
            <div class="panel-body">
                ...
                <form action="submit_product.php" id="AddProduct" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="disc" id="disc" cols=40 rows=5 class="form-control" onkeyup="countChar(this)" placeholder="Product description (Maximum 270 characters)"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  name="external" id="external" class="form-control" placeholder="Your external link of image" />
                    </div>
                    <div class="form-group">
