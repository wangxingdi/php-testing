        ...
        <section class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    <?php
                    if ($GetAdmin = $mysqli->query("SELECT * FROM mp_admin WHERE admin_id='1'")) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="inputUsername" name="inputUsername" class="form-control"
                                       ...
                                       value="<?php echo $AdminRow['admin_username'] ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" name="inputCurrentPassword"
                                       id="inputCurrentPassword" placeholder="Enter Your Current Password">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" name="inputConfirmPassword"
                                       id="inputConfirmPassword" placeholder="Retype New Password">
                            </div>
                        </div>
                </div>
                <div class="panel-footer clearfix">
                    <button type="submit" id="submitButton" class="btn btn-default btn-success btn-lg pull-right">Update
                        Credentials
                    </button>
                </div>
                </form>
