<?php include("header.php"); ?>
    ...
    <section class="col-md-10">
        ...
        <div class="page-header">
            <h3>Advertisements
                <small>Update website advertisements</small>
            </h3>
        </div>
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/jquery-form@4.2.2/dist/jquery.form.min.js"></script>
        <script>
        ...
        <section class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    <?php
                    if ($Ads = $mysqli->query("SELECT * FROM mp_ads")) {
                    ...
                    ?>
                    <div id="output"></div>
                    <form action="upload_featured_image.php" id="UploadImage" enctype="multipart/form-data"
                          method="post">
                        ...
                        <button style="margin-bottom: 10px;" type="submit" id="uploadBtn" name="UploadFeatImage" class="btn btn-default btn-primary">Update Featured Image
                        </button>
                    </form>
