                    ...
                    <form id="categoryForm" action="submit_category.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select id="inputParent" name="inputParent" class="form-control">
                                    ...
                                    <?php
                                    if ($cat_sql = $mysqli->query("SELECT * FROM mp_categories WHERE parent_id is null"))
                                    {
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="inputDescription" name="inputDescription" rows="3"
                                      placeholder="Enter description for your new category"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="inputIcon">Font Awesome Icon HTML (Use <a href="https://fontawesome.com"
                                                                                  target="_blank">FontAwesome.com</a>
                                only. Icons from other sources may not work.)</label>
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon fa  fa-info"></span></span>
                                <input type="text" id="inputIcon" name="inputIcon" class="form-control"
                                       placeholder="For example - <i class='fas fa-cogs'></i>">
                            </div>
                        </div>
