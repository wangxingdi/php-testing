<?php include("header.php");?>
    ...
    <section class="col-md-10">
        ...
        <section class="col-md-8">
            ...
            ?>
                    <ul>
                        <li class="has-sub"><a><span>常规设置</span></a>
                            <ul>
                                <form class="form-new" id="settingsForm" name="settingsForm" action="update_settings.php" enctype="multipart/form-data" method="post">
                                    <li>
                                        <div class="form-group">
                                            <label for="inputTitle">网站标题</label>
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <span class="glyphicon fa  fa-info"></span>
                                                </span>
                                                <input type="text" id="inputTitle" name="inputTitle" class="form-control" placeholder="输入你的网站标题..." value="<?php echo $SettingsRow['name']?>">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <label for="inputfile">网站 Logo (建议尺寸650px x 108px)</label>
                                            <input type="file" id="inputfile" name="inputfile" class="filestyle" data-iconName="glyphicon-picture" data-buttonText="select">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <label for="inputfavicon">网站 Favicon (请选择.ico格式的文件)</label>
                                            <input type="file" id="inputfavicon" name="inputfavicon" class="filestyle" data-iconName="glyphicon-picture" data-buttonText="select">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <label for="inputSiteurl">网站 URL (不要输入http://或者https://)</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="glyphicon fa fa-info"></span></span>
                                                <input type="text" id="inputSiteurl" name="inputSiteurl" class="form-control" placeholder="请输入- yourdomain.com 或者 www.yourdomain.com" value="<?php if(empty($SettingsRow['siteurl'])){ echo $websiteurl; } else{ echo $SettingsRow['siteurl']; } ?>">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <label for="inputDescription">网站 Meta描述</label>
                                            <textarea class="form-control" id="inputDescription" name="inputDescription" rows="3" placeholder="请输入网站meta描述..."><?php echo $SettingsRow['descrp']?></textarea>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <label for="inputKeywords">网站 Meta关键字</label>
                                            <textarea class="form-control" id="inputKeywords" name="inputKeywords" rows="3" placeholder="请输入网站meta关键字..."><?php echo $SettingsRow['keywords']?></textarea>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="inputEmail" name="inputEmail" class="form-control" placeholder="请输入网站电子邮件地址..." value="<?php echo $SettingsRow['email']?>">
                                            </div>
                                        </div>
                                    </li>
                            </ul>
                        </li>
                        <li class="has-sub"><a><span>文本内容设置</span></a>
                            <ul>
                                <div class="row">
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputHome">最左侧菜单文本(电脑端 & 移动端)</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                                                <input type="text" id="inputHome" name="inputHome" class="form-control" placeholder="请输入首页菜单文本..." value="<?php echo $SettingsRow['txt_home']?>">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputCategories">最右侧菜单文本</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                                                <input type="text" id="inputCategories" name="inputCategories" class="form-control" placeholder="请输入分类菜单文本.." value="<?php echo $SettingsRow['txt_all_cat']?>">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputPopular">Popular Menu Text (移动端)</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                                    ...
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputGiftGuides">Gift Guides Text (移动端)</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                                    ...
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputBuy">购买链接文本</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                                    ...
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputPriceSymbol">币种符号(默认'$')</label>
                                            <div class="input-group">
                                    ...
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputSave">关注按钮文本</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                                    ...
                                    <li>
                                        <div class="col-xs-6">
                                            <label for="inputRemove">取消按钮文本</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-font"></span></span>
                        ...
                        <li class="has-sub"><a><span>颜色设置</span></a>
                            <ul>
                                <li class="has-sub"><a><span>菜单调色板</span></a>
                                    <ul>
                                        <li>
                                            <table class="palette">
                                                <tr>
                                                    <td><input id="neon" type="radio" name="color-palette" value="One"></td><td style="background: linear-gradient(to bottom,#FAFAFA 0,#EDEDED 100%);color: #333;">首页</td><td style="background: linear-gradient(to bottom,#ff1493 0,#fa0087 100%);">菜单 1</td><td style="background: linear-gradient(to bottom,#120052 0,#0c0039 100%);">菜单 2</td><td style="background: linear-gradient(to bottom,#652ec7 0,#5a29b2 100%);">菜单 3</td><td style="background: linear-gradient(to bottom,#00c2ba 0,#00a9a2 100%);">菜单 4</td><td style="background: linear-gradient(to bottom,#82e0bf 0,#6edbb5 100%);">菜单 5</td><td style="background: linear-gradient(to bottom,#1C3648 0,#152836 100%);">更多</td>
                                                </tr>
                                                <tr>
                                                    <td><input id="pirate" type="radio" name="color-palette" value="One"></td><td style="background: linear-gradient(to bottom,#FAFAFA 0,#EDEDED 100%);color: #333;">首页</td><td style="background: linear-gradient(to bottom,#f42d2d 0,#f31515 100%);">菜单 1</td><td style="background: linear-gradient(to bottom,#14e141 0,#12ca3a 100%);">菜单 2</td><td style="background: linear-gradient(to bottom,#e2fd03 0,#cce502 100%);">菜单 3</td><td style="background: linear-gradient(to bottom,#bd1fc7 0,#a81cb1 100%);">菜单 4</td><td style="background: linear-gradient(to bottom,#18b8db 0,#15a5c4 100%);">菜单 5</td><td style="background: linear-gradient(to bottom,#1C3648 0,#152836 100%);">更多</td>
                                                </tr>
                                                <tr>
                                                    <td><input id="denial" type="radio" name="color-palette" value="One"></td><td style="background: linear-gradient(to bottom,#FAFAFA 0,#EDEDED 100%);color: #333;">首页</td><td style="background: linear-gradient(to bottom,#1f2369 0,#191c55 100%);">菜单 1</td><td style="background: linear-gradient(to bottom,#1e2a44 0,#161f32 100%);">菜单 2</td><td style="background: linear-gradient(to bottom,#122140 0,#0c172c 100%);">菜单 3</td><td style="background: linear-gradient(to bottom,#160736 0,#0d041f 100%);">菜单 4</td><td style="background: linear-gradient(to bottom,#08020a 0,#000000 100%);">菜单 5</td><td style="background: linear-gradient(to bottom,#0e1b24 0,#070d12 100%);">更多</td>
                                                </tr>
                                                <tr>
                                                    <td><input id="deep-rainbow" type="radio" name="color-palette" value="One"></td><td style="background: linear-gradient(to bottom,#FAFAFA 0,#EDEDED 100%);color: #333;">首页</td><td style="background: linear-gradient(to bottom,#b50606 0,#9c0505 100%);">菜单 1</td><td style="background: linear-gradient(to bottom,#fcd944 0,#fcd42b 100%);">菜单 2</td><td style="background: linear-gradient(to bottom,#0c6d63 0,#09564e 100%);">菜单 3</td><td style="background: linear-gradient(to bottom,#0b2a75 0,#09225e 100%);">菜单 4</td><td style="background: linear-gradient(to bottom,#572e8a 0,#4b2877 100%);">菜单 5</td><td style="background: linear-gradient(to bottom,#1C3648 0,#152836 100%);">更多</td>
                                                </tr>
                                                <tr>
                                                    <td><input id="rainbow" type="radio" name="color-palette" value="One"></td><td style="background: linear-gradient(to bottom,#9F009F 0,#860086 100%);color: #fff;">首页</td><td style="background: linear-gradient(to bottom,#4B0082 0,#3c0069 100%);">菜单 1</td><td style="background: linear-gradient(to bottom,#0000C5 0,#0000ac 100%);">菜单 2</td><td style="background: linear-gradient(to bottom,#008000 0,#006700 100%);">菜单 3</td><td style="background: linear-gradient(to bottom,#E3E300 0,#caca00 100%);">菜单 4</td><td style="background: linear-gradient(to bottom,#F49E00 0,#db8d00 100%);">菜单 5</td><td style="background: linear-gradient(to bottom,#F42400 0,#db2000 100%);">更多</td>
                                                </tr>
                                            </table>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-sub"><a><span>个性化调色</span></a>
                                    <ul>
                                        <!--
                                ...
                                <div class="btn-reset">
                                    <a id="resetMenuColors" class="btn btn-danger btnDelete" style="margin-top: 35px; float:left;">Reset Menu Colors to Default</a>
                                    <a id="resetAllColors" class="btn btn-danger btnDelete" style="margin-top: 35px;float: right;">Reset All Colors to Default</a>
                                </div>
