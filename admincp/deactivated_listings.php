...
<div class="page-header">
  <h3>Deactivated Products <small>Manage deactivated products</small></h3>
</div>
...
// How many adjacent pages should be shown on each side?
	...
	$query = $mysqli->query("SELECT COUNT(*) as num FROM listings WHERE active='3' ORDER BY id DESC");
	...
	if($page) 
 	...
 	/* Get data. */
	$result = $mysqli->query("SELECT * FROM listings WHERE active='3' ORDER BY id DESC LIMIT $start, $limit");
	...
	$q= $mysqli->query("SELECT * FROM listings WHERE active='3' ORDER BY id DESC limit $start,$limit");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				 ...
				 <p class="text-info"><small>You can re-deactivate this product listing by navigating to Product Listings > Active Products.</small></p>	
            </div>
            <!--/modal-body-collapse -->
            <div class="modal-footer">
