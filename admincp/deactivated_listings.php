<?php include("header.php"); ?>
    ...
    <section class="col-md-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Deactivated Products</li>
            <span class="theme-label">MarketPress v<?php echo $Settings['version']; ?></span>
        </ol>

        <div class="page-header">
            <h3>Deactivated Products
                <small>Manage deactivated products</small>
            </h3>
        </div>
...
//ajax ends
        ...
        <section class="col-md-8">
            ...
            $query = $mysqli->query("SELECT COUNT(*) as num FROM mp_products WHERE product_state='3' ORDER BY product_id DESC");
            ...
            $targetpage = "deactivated_listings.php";
            ...
            /* Get data. */
            $result = $mysqli->query("SELECT * FROM mp_products WHERE product_state='3' ORDER BY product_id DESC LIMIT $start, $limit");
            ...
            $q = $mysqli->query("SELECT * FROM mp_products WHERE product_state='3' ORDER BY product_id DESC limit $start,$limit");
                    ...
                    <tr class="btnDelete" data-id="<?php echo $Row['product_id']; ?>">
                        <td><a data-toggle="modal" href="preview.php?id=<?php echo $Row['product_id']; ?>"
                               data-target="#ProductModal"><img
                                        src="timthumb.php?src=http://<?php echo $SiteLink; ?>/uploads/<?php echo $Row['product_image']; ?>&amp;h=50&amp;w=50&amp;q=100"
                                        alt="<?php echo $LongTitle; ?>" class="img-responsive"></a></td>

                        <td><a data-toggle="modal" href="preview.php?id=<?php echo $Row['product_id']; ?>"
                               data-target="#ProductModal"><?php echo ucfirst($SortTitle); ?></a></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p class="text-info">
                                <small>You can re-deactivate this product listing by navigating to Product Listings >
                                    Active Products.
                                </small>
                            </p>
                        </div>
