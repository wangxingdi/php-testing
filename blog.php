                        ...
                        <div class="image" style="float: left; ">
                            <a href="blog/<?php echo $PageLink; ?>/">
                                <img class="img-responsive"
                                     src="../cache/timthumb.php?src=./images/<?php echo $row['product_image']; ?>&amp;h=178&amp;w=300&amp;q=100"
                                     alt="<?php echo $LongTitle; ?>">
                            </a>
                        </div>
                        <div class="blog-item-header" style="float: left; padding-right: 10px">
                            <h3 style="text-transform: uppercase;">
                                <a href="blog/<?php echo $PageLink; ?>/" class="ng-binding"><?php echo $tlong; ?></a>
                            </h3>
                            <div class="intro ng-binding"
                                 style="font-size: 14px; line-height: 1.75em;"><?php echo strip_tags($dlong); ?></div>
                            <div class="intro published-date ng-binding"><?php echo $date; ?></div>
                        </div>
                    </article>
                <?php } ?>
                <nav id="page-nav">
                ...
                <script>
                    $(".blog").infinitescroll({
                        ...
                        function (t, a, i) {
                            ...
                            }), $(".saves").unbind("click"), $(function () {
                                $(".saves").click(function () {
                                    var t = $(this).data("id"), a = $(this).data("name"), i = "id=" + t, e = $(this);
                            ...
                            }), $(".save-list").unbind("click"), $(function () {
