...
if($pageName == $protocol . $settings['siteurl'] . '/blog/'){
  $pageTitle = 'Blog';
} else {
  $pageTitle = '';
}
...
<meta charset="utf-8">
<title><?php echo $pageTitle . ' | ' . $settings['name']; ?></title>
...
<meta property="og:url"             content="<?php echo $protocol . $settings['siteurl']; ?>/blog/" /> 
<meta property="og:title"           content="<?php echo $pageTitle;?> | <?php echo $settings['name']; ?>" />
<meta property="og:description"   content="<?php echo strip_tags($settings['descrp']); ?>" /> 
...
<i class="fa fa-search"></i><input class="elasticsearch" name="term" type="text" autocomplete="off" placeholder="Search..." ng-change="search(term)" ng-model="term"></fieldset>
</form>
</span>
<a class="auto-localize" id="center-logo" href="<?php echo $protocol . $settings['siteurl']; ?>" target="_self"><img src="assets/logo.png" alt="<?php echo $settings['name']; ?>"></a>
<!-- MOBILE LOGIN START -->
    <div>
...
{
  $('.dropdown-content').css('max-height', '400px');
