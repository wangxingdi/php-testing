...
<div class="image" style="float: left; "><a href="view_post.php?link=<?php echo $PageLink; ?>"><img ng-src="timthumb.php?src=http://<?php echo $settings['siteurl'];?>/uploads/<?php echo $row['image'];?>" alt="<?php echo $LongTitle;?>" src="timthumb.php?src=https://<?php echo $settings['siteurl'];?>/uploads/<?php echo $row['image'];?>&amp;h=178&amp;w=300&amp;q=100"></a></div>
