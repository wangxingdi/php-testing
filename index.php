...
<ul><li><a id="newest" data-sort="110" <?php if ($sort==""){ echo "class=active"; }else if ($sort=="none"){ echo "class=active"; }?>><h3><i class="fas fa-bolt i-mod"></i><?php echo $txt_newest; ?></h3></a></li>
