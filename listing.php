...
<script>$(document).ready(function(){$(".csbuttons").cSButtons({total:"#total",url:"<?php echo $protocol . $settings['siteurl'];?>/<?php echo $PageLink;?>/"})}),$(function(){$(".saves").click(function(){var t=$(this).data("id"),a=$(this).data("name"),s="id="+t,e=$(this);return"save"==a&&($(this).fadeIn(200).html,$.ajax({type:"POST",url:"save_lists.php",data:s,cache:!1,success:function(t){e.html(t)}})),!1})}),$(function(){$(".save-list").click(function(){var t=$(this).data("id"),a=$(this).data("name"),s="id="+t,e=$(this);return"save"==a&&($(this).fadeIn(200).html,$.ajax({type:"POST",url:"save_lists.php",data:s,cache:!1,success:function(t){e.parent().parent().parent().find(".saves").html(t)}})),!1})});</script>
<div class="col-top col-top-mod"><div class="col-md-8 col-md-8-mod listing-mobile wow fadeIn"><div class="col-holder"><div class="col-info mobile-remove"><div class="col-info-left"><h1 class="title-mod"><?php echo $row['title'];?></h1>
<?php if(!isset($_SESSION['username'])){?>
<span class="info-saves"><a onclick="openLogin()"><span class="fas fa-heart"></span> &nbsp;<?php echo $row['saves'];?> saves</a></span>
<?php }else{
  if($count_save_listing==1)
  { ?>
    <span class="info-saves"><a class="saves remove-save" id="save-<?php echo $listing;?>" data-id="<?php echo $listing;?>" data-name="save" title="You have saved this. Click to remove."><span class="fas fa-heart"></span> &nbsp;<?php echo $row['saves'];?> saves</a></span>
<?php  
  }
  else
  { ?>
    <span class="info-saves"><a class="saves" id="save-<?php echo $listing;?>" data-id="<?php echo $listing;?>" data-name="save" title="Click to save this item."><span class="fas fa-heart"></span> &nbsp;<?php echo $row['saves'];?> saves</a></span>
<?php  
  }  
 }?>
...
<?php if(!isset($_SESSION['username'])){?>
<a onclick="openLogin()" class="btn-product btn-product-mod btn btn-warning btn-block btn-lg btn-font btn-wishlist desktop-remove"><i class="fas fa-cart-plus"></i> ADD TO WISHLIST</a>
<?php }else{
if($count_save_listing==1)
{ ?>
 <a id="btn-wishlist" class="btn-product btn-product-mod btn btn-warning btn-block btn-lg btn-font btn-wishlist-remove desktop-remove save-list remove-list" id="wishlist-<?php echo $listing;?>" data-id="<?php echo $listing;?>" data-name="save"><i class="fas fa-trash-alt"></i> REMOVE FROM WISHLIST</a>
<?php
}else { ?>
<a id="btn-wishlist" class="btn-product btn-product-mod btn btn-warning btn-block btn-lg btn-font btn-wishlist desktop-remove save-list" id="wishlist-<?php echo $listing;?>" data-id="<?php echo $listing;?>" data-name="save"><i class="fas fa-cart-plus"></i> ADD TO WISHLIST</a>
<?php
}
} ?>
...
<a class="btn-product btn-product-mod btn btn-warning btn-block btn-lg btn-font btn-pull btn-pull-mod btn-checkout" href="offer_link.php?id=<?php echo $row['id'];?>" target="_blank"><i class="fas fa-money-check-alt"></i> <?php echo $settings['buy_button'];?></a> <br />
</div><!--col-center-items--></div><!--col-sm-top--></div><!--col-md-4--></div><!--col-top--></div><!-- /.container -->
...
<div class="other-titles"><h3><?php echo $txt_related; ?></h3></div>
<?php
...
<a class="btn btn-default btn-lg btn-danger btn-font" onclick="openLogin()"><?php echo $txt_save; ?></a>
<?php }else{
$user_sql=$mysqli->query("SELECT * FROM saves WHERE listing_id='$listing_id' AND user_id='$Uid'");
...
<?php if(!isset($_SESSION['username'])){?>
<span class="info-saves"><a onclick="openLogin()"><span class="fas fa-heart"></span> &nbsp;<?php echo $RelRow['saves'];?> saves</a></span>
<?php }else{
  if($count_save==1)
  { ?>
    <span class="info-saves"><a class="saves remove-save" id="save-<?php echo $listing_id;?>" data-id="<?php echo $listing_id;?>" data-name="save" title="You have saved this. Click to remove."><span class="fas fa-heart"></span> &nbsp;<?php echo $RelRow['saves'];?> saves</a></span>
<?php  
  }
  else
  { ?>
    <span class="info-saves"><a class="saves" id="save-<?php echo $listing_id;?>" data-id="<?php echo $listing_id;?>" data-name="save" title="Click to save this item."><span class="fas fa-heart"></span> &nbsp;<?php echo $RelRow['saves'];?> saves</a></span>
<?php  
  }  
 }?> 
  <span class="info-saves"> &nbsp;<i class="fas fa-eye"></i>&nbsp;&nbsp;<?php echo $view_count; ?> views</span>
