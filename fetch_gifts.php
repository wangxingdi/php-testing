...
<a href="<?php echo $PageLink;?>/"><h2><?php echo $tlong;?></h2></a><div class="col-holder"><a class="col-link" href="offer_link.php?id=<?php echo $row['product_id'];?>" target="_blank"><img class="img-responsive" src="images/resizer/301x250/r/<?php echo $row['product_image'];?>" alt="<?php echo $LongTitle;?>"></a>
<div class="col-share">
