...
while ($row = mysqli_fetch_array($result)) {
    ...
    <div <?php if ($count > 3) {
        ...
        <div class="col-holder"><a class="col-link" href="offer_link.php?id=<?php echo $row['product_id']; ?>"
                                   target="_blank"><img class="img-responsive"
                                                        src="images/resizer/301x250/r/<?php echo $row['product_image']; ?>"
                                                        alt="<?php echo $LongTitle; ?>"></a>
            <div class="col-share">
